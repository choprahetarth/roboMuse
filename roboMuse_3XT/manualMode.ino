...
void manualMode(){
  displayControls();
  while(true){  // Repeat untill broken using interrupt
    ...
    if(commandFromSerial == "f"){
      ...
      if(motionType == "f"){ leftMotorSpeed += 5; rightMotorSpeed += 5; }
      else if(motionType == "l"){ leftMotorSpeed -= 5; rightMotorSpeed += 5; }
      else if(motionType == "r"){ leftMotorSpeed += 5; rightMotorSpeed -= 5; }
      else { leftMotorSpeed -= 5; rightMotorSpeed -= 5; }
